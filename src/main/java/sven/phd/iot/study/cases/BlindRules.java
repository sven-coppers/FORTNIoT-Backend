...
public class BlindRules extends StudyRuleSet {
    ...
    public void createRules(RulesManager rulesManager) {
        ...
        sunBelowHorizonTrigger.addAction(new StateAction("lower the blinds", BlindDevices.LIVING_BLINDS, "lowered"));
        ...
        sunAboveHorizonTrigger.addAction(new StateAction("raise the blinds", BlindDevices.LIVING_BLINDS, "raised"));
        ...
        windyTrigger.addAction(new StateAction("raise the blinds", BlindDevices.LIVING_BLINDS, "raised"));
        rulesManager.addRule(windyTrigger);
        windyTrigger.setTitle("IF wind speed reaches 50KM/H, raise the blinds");
    }
}
