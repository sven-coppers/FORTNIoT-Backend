...
public class ChildrenTempRules extends StudyRuleSet {
    ...
    public void createRules(RulesManager rulesManager) {
        ...
        Trigger eveningTrigger = new StateTrigger("rule.evening_children", "sensor.routine", "evening", "evening");
        ...
        Trigger sleepingTrigger = new StateTrigger("rule.sleeping_children", "sensor.routine", "sleeping", "everyone is sleeping");
