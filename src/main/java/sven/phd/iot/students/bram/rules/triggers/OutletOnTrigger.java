...
public class OutletOnTrigger extends Trigger {
    private String outletId;

    public OutletOnTrigger(String ruleIdentifier, String outletId) {
        super(ruleIdentifier, "When " + outletId + " toggles on");
    ...
    public List<HassioContext> verify(HashMap<String, HassioState> hassioStates) {
        ...
        if (hassioState.state.equals("on")) {
            System.out.println(this.outletId + " is now turned on!");
