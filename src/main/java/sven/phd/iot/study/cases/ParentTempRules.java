...
public class ParentTempRules extends StudyRuleSet {
    @Override
    public void createRules(RulesManager rulesManager) {
        ...
        Trigger eveningTrigger = new StateTrigger("rule.evening_parents", "sensor.routine", "evening", "evening");
        ...
        Trigger sleepingTrigger = new StateTrigger("rule.sleeping_parents", "sensor.routine", "sleeping", "everyone is sleeping");
