...
public class BedroomTempDevices extends DeviceSet {
    ...
    public void createDevices(ArrayList<HassioDevice> devices) {
      ...
      //  devices.add(new HassioThermostat(BEDROOM_THERMOSTAT, "Bedroom target temperature"));
        devices.add(new HassioHeater(BEDROOM_HEATING, "Bedroom heater", 0.2, 0.5, BEDROOM_THERMOSTAT, BEDROOM_TEMPERATURE, false, false));
        devices.add(new HassioCooler(BEDROOM_AIRCO, "Bedroom air conditioning", -0.3, 0.0, BEDROOM_THERMOSTAT, BEDROOM_TEMPERATURE, false, false));
    }
}
