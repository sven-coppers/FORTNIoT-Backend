...
public class TVRulesInconsistency extends RuleSet {
    ...
    public void createRules(RulesManager rulesManager) {
        ...
        leisure.addTrigger(new StateTrigger("", RoutineDevices.ROUTINE, "evening", "evening"));
        ...
        Trigger sleepingTrigger = new StateTrigger("rule.sleeping_tv", RoutineDevices.ROUTINE, "sleeping", "routine = sleeping");
