...
public class LivingTempRules extends RuleSet {
    ...
    public void createRules(RulesManager rulesManager) {
        ...
        nobodyHomeTrigger.addAction(new ThermostatStateAction(LivingTempDevices.LIVING_THERMOSTAT, "living target temperature", 15.0));
        rulesManager.addRule(nobodyHomeTrigger);

        Trigger comesHomeTrigger = new PeopleHomeTrigger("rule.comes_home",true);
        comesHomeTrigger.addAction(new ThermostatStateAction(LivingTempDevices.LIVING_THERMOSTAT, "living target temperature", 21.0));
        ...
        eveningTrigger.addAction(new ThermostatStateAction(LivingTempDevices.LIVING_THERMOSTAT, "living target temperature", 21.0));
        ...
        morningTrigger.addAction(new ThermostatStateAction(LivingTempDevices.LIVING_THERMOSTAT, "living target temperature", 21.0));
        ...
        sleepingTrigger.addAction(new ThermostatStateAction(LivingTempDevices.LIVING_THERMOSTAT, "living target temperature", 15.0));
